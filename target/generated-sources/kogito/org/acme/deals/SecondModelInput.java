...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "second", name = "Second", hidden = true)
@ProcessInput(processName = "second")
public class SecondModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<SecondModel> {
    ...
    @Override()
    public SecondModel toModel() {
        SecondModel result = new SecondModel();

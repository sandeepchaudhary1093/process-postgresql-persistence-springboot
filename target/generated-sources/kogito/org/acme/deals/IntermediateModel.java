...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "intermediate", name = "Intermediate", hidden = false)
public class IntermediateModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<IntermediateModelOutput> {
    ...
    @Override()
    public IntermediateModelOutput toModel() {
        IntermediateModelOutput result = new IntermediateModelOutput();
        result.setId(getId());
